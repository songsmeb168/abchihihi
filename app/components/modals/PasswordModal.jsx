        ...
        <>
            ...
            >
                ...
                >
                    ...
                    <p className="">For your security, you must enter your password to continue.</p>
                    <Form.Item
                        name="password"
                        rules={[
                            {
                    ...
                    <Form.Item className='ant-submit-button'>
                        ...
                        >
                            {loadingPassword ? '' : "Continue"}
                        </Button>
                        <p className='forgot-password' style={{textAlign: 'center', cursor: 'pointer'}}>Forgot your password?</p>
                    </Form.Item>
                </Form>
